...
[%notitle,background-iframe="http://www.onet.pl"]
=== sekcja 


//data-background-iframe="https://example.com"}

//image::.html/sections.html[background, size=contain]

// +++<body style="margin:0px;padding:0px;overflow:hidden">
//     <iframe src="http://www.onet.pl" frameborder="0" style="overflow:hidden;height:100%;width:100%" height="100%" width="100%"></iframe>
// </body>+++

=== Sekcje2 

+++<section data-background-iframe="./html/sections.html">
					<h2>Iframe background</h2>
  </section>+++

//+++<section data-background-iframe="https://html/sections.html"></section>+++

[%conceal]
=== Sekcje 

+++<iframe width="100%" height="100%"  marginheight="0" marginwidth="0" src="./html/sections.html">
...
+++<iframe width="100%" height="100%"  marginheight="0" marginwidth="0" src="./html/paragraph.html">
  Fallback text here for unsupporting browsers, of which there are scant few.
</iframe>+++
...
+++<iframe width="100%" height="100%"  marginheight="0" marginwidth="0" src="./html/lists.html">
  Fallback text here for unsupporting browsers, of which there are scant few.
</iframe>+++
...
+++<iframe width="100%" height="100%"  marginheight="0" marginwidth="0" src="./html/format.html">
  Fallback text here for unsupporting browsers, of which there are scant few.
</iframe>+++
...
+++<iframe width="100%" height="100%"  marginheight="0" marginwidth="0" src="./html/tabel.html">
  Fallback text here for unsupporting browsers, of which there are scant few.
</iframe>+++

...
== Na szczęście są Lekkie Jezyków Znaczników

[.notes]
****
* ale od jakiegoś czasu dostępne sa Lekkie odmiany: Markup Languages, kótre potrafią prostą składnią
* Zdefiniować treść
...
+++<a href="https://github.com/Pirgos/ex_markup_languages" target="_blank">Języki znaczników wspieane przez GITHUB:</a>+++
...
image::docToolchain.png[alt text,width=600px]

...
* Proces wytwórczy dokumentów a cykl wytwórczy oprogramowania
...
[.notes]
****
* tworzyć treść, i ją formatować to często inne rzeczy 
* często poza kompetencją jednej osoby, a może i działu
****
...
****
* np.
* firma zmienia logo to jeżeli mamy formę prezentacji wydzieloną to możemy tanio dokumenty wygenerować ponownie 
* firma chce archiwizować treść dokumentacji - taniej bez narzutu przeznaczonego dla formy
****
...
[%notitle, background-image="./images/ms_github.gif"]
=== github
...
[%notitle, background-image="./images/ms_net-apib.gif"]
=== web_editing

[.notes]
****
migration of all .NET Framework documentation in 11 locales from MSDN to docs.microsoft.com
****
...
== Google też zmieniło wewnętrzny proces dokumentacji
